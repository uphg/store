...
date: 2020-05-13T22:31:32+08:00
categories:
    - 前端
tags:
    - JavaScript
...
日期： [2019年8月 6日](http://www.ruanyifeng.com/blog/2019/08/)
...
<img :src="$withBase('/images/bg2019080604.jpg')" alt="图片">

## 一、自定义元素

下图是一个用户卡片。

<img :src="$withBase('/images/bg2019080405.jpg')" alt="图片">
...
本文转载自：[http://www.ruanyifeng.com/blog/2019/08/web_components.html](http://www.ruanyifeng.com/blog/2019/08/web_components.html)